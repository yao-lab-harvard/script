...
DigitalOut('pb_3',pb.direct_outputs, 'flag 3') #FPGA trigger
...
pb_1.go_low(t+1.25*ctrGateDuration) #stop reference counts
t+=10e-6
...
pb_1.go_low(t+1.75*ctrGateDuration) #stop reference counts
t+=10e-6
pb_1.go_high(t) #start reference counts
